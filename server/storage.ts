  ...
  async getTickets(): Promise<(Ticket & { customerName?: string; customerCode?: string; customerPhone?: string; customerArea?: string })[]> {
    const result = await db
      .select({
        ...
        cirCustomerId: tickets.cirCustomerId,
        corporateCustomerId: tickets.corporateCustomerId,
        ...
        supportGroup: tickets.supportGroup,
        entityId: tickets.entityId,
        entityName: tickets.entityName,
        entityCode: tickets.entityCode,
        entityEmail: tickets.entityEmail,
        entityPhone: tickets.entityPhone,
        entityBranch: tickets.entityBranch,
        customerSubType: tickets.customerSubType,
        complainedNumber: tickets.complainedNumber,
