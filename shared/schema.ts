...
export const resellers = pgTable("resellers", {
  ...
  cnicBackPicture: text("cnic_back_picture"),
  officePicture: text("office_picture"),
  agreementFile: text("agreement_file"),
  registrationFormPicture: text("registration_form_picture"),
  vendorId: integer("vendor_id"),
  packageId: integer("package_id"),
  assignedPackages: text("assigned_packages"),
  commissionType: text("commission_type").default("fixed_rate"),
  commissionRate: decimal("commission_rate", { precision: 5, scale: 2 }).default("10"),
  commissionProfitRate: decimal("commission_profit_rate", { precision: 5, scale: 2 }).default("0"),
...
export const cirCustomers = pgTable("cir_customers", {
  ...
  bandwidthMbps: text("bandwidth_mbps"),
  perMbpsRate: text("per_mbps_rate"),
  monthlyBilling: text("monthly_billing"),
  billingDiscount: text("billing_discount"),
  otcAmount: text("otc_amount"),
  ...
  cnicFrontFile: text("cnic_front_file"),
  cnicBackFile: text("cnic_back_file"),
...
export const corporateCustomers = pgTable("corporate_customers", {
  ...
  snmpMonitoring: boolean("snmp_monitoring").default(false),
  trafficAlerts: boolean("traffic_alerts").default(false),
  billingMode: text("billing_mode").default("fixed"),
  perMbpsRate: decimal("per_mbps_rate", { precision: 10, scale: 2 }).default("0"),
  bandwidthMbps: decimal("bandwidth_mbps", { precision: 10, scale: 2 }).default("0"),
...
export const oltDevices = pgTable("olt_devices", {
  ...
  snmpPortType: text("snmp_port_type").default("UDP"),
